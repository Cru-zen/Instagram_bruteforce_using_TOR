...
if os.name == "nt":
    print("Sorry ! this tool is ONLY FOR LINUX USERS")
    exit(1)
# check For root <= ~ 
def Root():
    ...
    if os.geteuid() == 0:
        ...
        ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣦⣤⣤⣤⣤⣤⣽⣿⣿⣿⣿⣿⣿⣷⣷⣾⣷⣾⣿⣿⣿⣿⣿⣿⣦⣤⣤⣤⣤⣤⣿⣿⣿⣿⣿⣿⣿⣿⣿
        ⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
{reset}       /*   remember this tool is only for Linux system   */
                        
           c o d e d by{red}Cru-zen{reset} | insta : {red}anant_singh_rathore{reset} | github : {red}Cru-zen{reset}
